...
def validate_data(values):
    ...
    Raises ValueError if strings cannot be converted to ints,
...
def update_sales_worksheet(data):
    ...
    print("New line updated sucessfully.\n")
